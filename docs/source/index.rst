...
This is a BalderHub project that provides different kind of features to work with waveform generating devices like signal generators.

.. note::
   Please note, this package is still under development. If you would like to contribute, take a look into the
   `project <https://github.com/balder-dev/balderhub-waveformgenerator/>`_.
